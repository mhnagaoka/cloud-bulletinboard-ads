...
public class CustomExceptionMapper extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler
    public ResponseEntity<Object> handleConstraintViolationException(MethodArgumentTypeMismatchException exception,
                                                                     WebRequest request) {
        List<DetailError> errors = new ArrayList<DetailError>();
        errors.add(new DetailError(exception.getMessage()));
